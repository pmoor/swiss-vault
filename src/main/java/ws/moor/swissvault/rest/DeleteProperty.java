...
@Delete(path = "/keys/{keyId}/secrets/{secretId}/properties/{propertyId}")
public class DeleteProperty implements RestAction{
  ...
  @Inject
  DeleteProperty(ParameterExtractor parameterExtractor, SecretRepository secretRepository, Transaction transaction) {
  ...
  public void remove() {
    ...
    secretRepository.deleteProperty(transaction, keyId, secretId, propertyId);
    transaction.commit();
  }
}

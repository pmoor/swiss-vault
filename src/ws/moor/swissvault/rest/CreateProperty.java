...
@Post(path = "/keys/{keyId}/secrets/{secretId}/properties")
public class CreateProperty implements RestAction {
  ...
  @Execute
  public JsonObject create(@RequestBody JsonObject json) throws EntityNotFoundException {
    ...
    DbSecretProperty dbSecretProperty = secretRepository.newSecretProperty(transaction, secret, json);
    transaction.commit();

    return dbSecretProperty.toJsonObject(obfuscator);
  }
}

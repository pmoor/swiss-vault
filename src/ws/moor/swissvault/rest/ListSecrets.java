...
@Get(path = "/keys/{keyId}/secrets")
public class ListSecrets implements RestAction {
  ...
  @Inject
  ListSecrets(Obfuscator obfuscator, SecretRepository secretRepository, ParameterExtractor parameterExtractor,
  ...
  public JsonArray list() {
    ...
    for (DbSecret secret : secretRepository.listSecrets(transaction, keyId)) {
      response.add(secret.toJsonObject(obfuscator));
    }
    return response;
  }
}
